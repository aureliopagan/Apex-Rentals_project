  ...
  if (!isAuthenticated || user?.user_type !== 'owner') {
    return (
      <div className="container" style={{ padding: '4rem 2rem', textAlign: 'center' }}>
        <h2>Access Denied</h2>
        <p>Only asset owners can add new assets.</p>
        ...
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
            ...
            <p style={{ color: '#666666', fontSize: '1.1rem' }}>
              Share your premium yacht, exotic car, or private jet with discerning clients
            </p>
          </div>
                ...
                <div style={{ marginBottom: '1rem' }}>
                  <label 
                    ...
                    style={{ 
                      ...
                      backgroundColor: images.length >= 5 ? '#999999' : '#d4af37',
                      color: 'white',
                      borderRadius: '0.5rem',
                  ...
                  >
                    📷 {images.length >= 5 ? 'Max Images Reached' : `Add Images (${images.length}/5)`}
                  </label>
                  <input
                    id="images"
                    type="file"
